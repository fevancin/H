...
from solvers.solve_instance import solve_instance


if __name__ != '__main__':
    exit(0)

parser = argparse.ArgumentParser(prog='Run tests', description='Solve groups of master instances.')
...
parser.add_argument('-c', '--configs', type=Path, help='Solving configuration', required=True)
